...
Under_scores are forbidden by some programming style guides but let's follow 
...
Strings in PHP are an array of characters so accessing an individual character 
