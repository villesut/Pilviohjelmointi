...
function loadList() {
	...
	for (var i=0; i<notes.length; i++) {
		...
		row.id = i;
		row.innerHTML = '<td><a onclick="display(this)" href="#">'+notes[i].title+'</a></td><td><a onclick="updateNote()" href="#">save</a></td><td><a onclick="rem(this)" class="delete" href="#">delete</a></td>';
